...
public:
    ...
    static Ceres_pose_graph_3d::Constraint3d add_constrain_of_loop(int s_idx,                                       // curr_finished_keyframe_index
    ...
    void init(std::string path)
    {
        ...
        m_pc_reg.m_para_max_angular_rate = 360;   // 没用到, loop closure时:  没有通过函数的返回值是0 or 1 来判断是否对齐, 而是通过m_inlier_threshold来判断
                                      ...
                                      std::string mapping_save_path = std::string(" "))
    {
        ...
        m_pc_reg.m_para_cere_max_iterations = 200;
