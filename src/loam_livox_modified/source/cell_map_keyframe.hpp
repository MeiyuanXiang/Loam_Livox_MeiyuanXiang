...
public:
    ...
    public:
        ...
        Map_pt_cell_it m_map_pt_cell_it;
        pcl::PointCloud<pcl::PointXYZ>::Ptr m_pcl_cells_center = pcl::PointCloud<pcl::PointXYZ>::Ptr(new pcl::PointCloud<pcl::PointXYZ>()); // 所有cells center
